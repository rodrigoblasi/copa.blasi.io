...
display as critical. Otherwise include tests when explicitly requested.
...
### Tests for User Story 1 (REQUIRED if constitution-critical) ⚠️
...
- Tests required by constitution-critical data, scheduler, fallback, logging, or
  public result behavior MUST be written and fail before implementation, or a
  documented validation alternative MUST be approved in plan.md
